...
export async function middleware(request: NextRequest) {
  ...
  if (ruta.startsWith("/reservar") || ruta.startsWith("/baja") || ruta.startsWith("/kiosco") || ruta.startsWith("/api/publico") || ruta.startsWith("/api/rrhh/fichar") || ruta.startsWith("/empleado-manifest")) {
